...
__device__ double *cartesianToSpherical(double *coords, int dim){
...
__device__ double *sphericalToCartesian(double *coords, int dim){
...
__device__ double *sphericalToCartesianVelocity(double *coords, double *velocities, int dim){
...
__device__ double *cartesianToSphericalVelocity(double *coords, double *velocities, int dim){
