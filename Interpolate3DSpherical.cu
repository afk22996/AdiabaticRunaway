...
__device__ int* binSearch(double *vals, int left, int right, double target, int size){
    int middle;
...
__device__ double triInterpolate(double *targetCoords, double *cubeVals, double *minCoords, double *maxCoords){
...
__device__ double getData(double *data, int zpoint, int ypoint, int xpoint, int zres, int yres, int xres){
    int idx = 0;
...
__device__ double interpolate3DSpherical(double *xVals, double *yVals, double *zVals, double *data, double *r, int xres, int yres, int zres){
    double x1, x2, x3;
